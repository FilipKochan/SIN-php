...
<body>
    <nav>
        <ul>
            <li><a href="index.php?sekce=10">Úvodní
                    strana</a><?php if ($sekce == 10) echo " <i class=\"far fa-hand-point-left\"></i>"; ?></li>
            <li><a
                    href="index.php?sekce=20">Formulář</a><?php if ($sekce == 20) echo " <i class=\"far fa-hand-point-left\"></i>"; ?>
            </li>
            <li><a
                    href="index.php?sekce=30">Kontakt</a><?php if ($sekce == 30) echo " <i class=\"far fa-hand-point-left\"></i>"; ?>
            </li>
        </ul>
    </nav>
    ...
    <form>
        <div class="input">
            <input type="text" name="cislo1" placeholder="číslo 1"
                value="<?php if (isset($_REQUEST["cislo1"]) && is_numeric($_REQUEST["cislo1"])) echo $_REQUEST["cislo1"] ?>">
        ...
        <div class="input">
            <select name="operace" id="operace">
                <option value="+"
                    <?php if (isset($_REQUEST["operace"]) && $_REQUEST["operace"] == "+") echo "selected=\"true\""; ?>>+
                </option>
                <option value="-"
                    <?php if (isset($_REQUEST["operace"]) && $_REQUEST["operace"] == "-") echo "selected=\"true\""; ?>>-
                </option>
